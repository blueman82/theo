...
def _do_tracking(hook_input: dict[str, Any]) -> None:
    ...
    try:
        ...
        # Intelligent filtering: only store meaningful memories
        should_store, mem_type, importance = _should_store(parsed)
        if should_store:
            _store_meaningful_memory(parsed, mem_type, importance)
